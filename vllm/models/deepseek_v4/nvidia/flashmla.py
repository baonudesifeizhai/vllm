...
class DeepseekV4FlashMLASparseImpl(DeepseekV4SparseMLAAttentionImpl):
    ...
    def _forward_decode(
        ...
        out, lse = flash_mla_with_kvcache(
            ...
            attn_sink=None if pcp_group is not None else layer.attn_sink,
        ...
        if pcp_group is not None:
            ...
            _apply_attn_sink_and_copy(merged_out, merged_lse, layer.attn_sink, output)
        ...
        for chunk_idx in range(num_chunks):
            ...
            if pcp_group is not None:
                ...
                _apply_attn_sink_and_copy(
                    merged_out, merged_lse, layer.attn_sink, out_slice
                )
