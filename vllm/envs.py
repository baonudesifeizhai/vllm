...
if TYPE_CHECKING:
    ...
    VLLM_GEMMA4_MTP_FUSED_QNORM_ROPE: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Fuse Gemma4 MTP Q RMSNorm + RoPE with vLLM's fused_qk_norm_rope op.
    "VLLM_GEMMA4_MTP_FUSED_QNORM_ROPE": lambda: bool(
        int(os.getenv("VLLM_GEMMA4_MTP_FUSED_QNORM_ROPE", "0"))
    ),
